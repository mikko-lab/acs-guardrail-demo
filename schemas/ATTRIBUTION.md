# Agent Control Standard (ACS) Schemas
...
See the root [NOTICE](../NOTICE) and [LICENSE](../LICENSE) files for full licensing details. This project is not affiliated with, nor endorsed by, the OWASP Foundation or the Agent Control Standard project.
